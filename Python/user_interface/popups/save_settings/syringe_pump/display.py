...
from user_interface.popups.save_settings.syringe_pump.functions import saveSyringePumpSettingsFunctions

##-\-\-\-\-\-\-\-\-\-\-\-\-\-\
## WINDOW FOR READING METADATA
##-/-/-/-/-/-/-/-/-/-/-/-/-/-/

class saveSyringePumpSettingsWindow(qtw.QMainWindow, saveSyringePumpSettingsFunctions):
    def __init__(self, parent, syringe_group=None, syringe_axis=None):
        super(saveSyringePumpSettingsWindow, self).__init__(parent)
