...
from user_interface.popups.load_settings.syringe_pump.functions import loadSyringePumpSettingsFunctions

##-\-\-\-\-\-\-\-\-\-\-\-\-\-\
## WINDOW FOR READING METADATA
##-/-/-/-/-/-/-/-/-/-/-/-/-/-/

class loadSyringePumpSettingsWindow(qtw.QMainWindow, loadSyringePumpSettingsFunctions):
    def __init__(self, parent, interface=None, syringe_group=None, syringe_axis=None):
        super(loadSyringePumpSettingsWindow, self).__init__(parent)
