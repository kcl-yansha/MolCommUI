...
from user_interface.equipment_calibration.gearboxes.editor.functions import editGearboxCalibrationFunctions

##-\-\-\-\-\-\-\-\-\-\-\-\-\-\
## WINDOW FOR READING METADATA
##-/-/-/-/-/-/-/-/-/-/-/-/-/-/

class editGearboxCalibrationWindow(qtw.QMainWindow, editGearboxCalibrationFunctions):
    def __init__(self, parent, calibration_manager=None, gearbox_name=None):
        super(editGearboxCalibrationWindow, self).__init__(parent)
        ...
        self.setWindowTitle("Edit Gearbox")
        ...
        self.initialiseWindow(gearbox_name=gearbox_name)
    ...
    def closeEvent(self, event=None):
        ...
        # Close the window
        event.accept()
        self.parent.subWindows['edit_gearbox'] = None
    ...
    def createSettingsDisplay(self, parentWidget):
        ...
        # Add ratio
        self.ratioEntry = qtw.QSpinBox()
        self.ratioEntry.setMinimum(0)
        self.ratioEntry.setMaximum(10000)
        self.settingsLayout.addRow('Gear Ratio (1:)', self.ratioEntry)
