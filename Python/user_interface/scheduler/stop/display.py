...
from user_interface.scheduler.stop.functions import setStopFunctions

##-\-\-\-\-\-\-\-\-\-\-\-\-\-\
## WINDOW FOR READING METADATA
##-/-/-/-/-/-/-/-/-/-/-/-/-/-/

class setStopWindow(qtw.QMainWindow, setStopFunctions):
    def __init__(self, parent, event=None, parent_widget=None):
        super(setStopWindow, self).__init__(parent)
    ...
    def closeEvent(self, event=None):
        ...
        # Close the window
        event.accept()
        self.parent.subWindows['edit_stop'] = None
    ...
    def createUserActions(self, parentWidget):
        ...
        self.newButton.clicked.connect(self.setStop)
