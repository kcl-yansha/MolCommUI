...
from multithreading.scheduler.events import Stop
...
class setStopFunctions(object):
    ...
    def _read_values(self):
        ...
        return selected_pumps, duration
    ...
    def setStop(self):
        ...
        selected_pumps, duration = self._read_values()
        ...
        if self.event is None:
            ...
            new_event = Stop(selected_pumps, duration)
